...
const characters: Character[] = [
  {
    ...
    name: "わーわー",
    role: "村長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/02_わーわー.png",
  ...
  },
  {
    ...
    name: "すーすー",
    role: "助手長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/01_すーすー.png",
  ...
  },
  {
    ...
    name: "もぐぴよ",
    role: "口腔育成部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/07_もぐぴよ.png",
  ...
  },
  {
    ...
    name: "けとにゃん",
    role: "健康文化部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/06_けとにゃん.png",
  ...
  },
  {
    ...
    name: "わのの",
    role: "つながり担当",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/04_わのの.png",
  ...
  },
  {
    ...
    name: "ラピ子",
    role: "未病美容部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/12_ラピ子.png",
  ...
  },
  {
    ...
    name: "たぬぺい",
    role: "夢とお金の文化部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/03_たぬぺい.png",
  ...
  },
  {
    ...
    name: "シンボー",
    role: "からだ改革部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/05_シンボー.png",
  ...
  },
  {
    ...
    name: "炎症わーわー",
    role: "おくちの火消し部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/11_炎症.png",
  ...
  },
  {
    ...
    name: "糖化わーわー",
    role: "血糖値管理して部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/10_糖化.png",
  ...
  },
  {
    ...
    name: "酸化わーわー",
    role: "おくち閉じるぞ部長",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/09_酸化.png",
  ...
  },
  {
    ...
    name: "歯医者のごりさん",
    role: "歯科の見守り役",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/22_歯医者のごりさん.png",
  ...
  },
  {
    ...
    name: "セイウッチー",
    role: "海の応援係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/20_セイウッチー.png",
  ...
  },
  {
    ...
    name: "かむむ",
    role: "かむ力の練習係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/17_かむむ.png",
  ...
  },
  {
    ...
    name: "はぐりん",
    role: "歯ぐき見守り係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/14_はぐりん.png",
  ...
  },
  {
    ...
    name: "チッピッピ",
    role: "小さな気づき係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/08_チッピッピ.png",
  ...
  },
  {
    ...
    name: "すくまる",
    role: "成長見守り係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/19_すくまる.png",
  ...
  },
  {
    ...
    name: "ミエル",
    role: "見える化係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/15_ミエル.png",
  ...
  },
  {
    ...
    name: "マミュー",
    role: "やさしい見守り係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/21_マミュー.png",
    tone: "ふんわり包む。詳細は未設定",
    fit: "親子、安心、自愛、寝る前の習慣",
  ...
  },
  {
    ...
    name: "てんぴよ",
    role: "お天気小ぼけ係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/16_てんぴよ.png",
  ...
  },
  {
    ...
    name: "すくすけ",
    role: "すくすく応援係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/18_すくすけ.png",
  ...
  },
  {
    ...
    name: "えまひめ",
    role: "笑顔の案内係",
    image: "/content/01_すわぷよ/01_キャラクター/02_表示用/13_えまひめ.png",
...
export function ShortsStudioMock() {
  ...
  const currentRenderSpec = useMemo<RenderReadySpec>(() => ({
    ...
    size: [1080, 1920],
    fps: 30,
    background: "public/content/01_すわぷよ/03_背景/01_村_昼.png",
  ...
  const renderCommand = `python3 shorts/render.py public/content/03_ショート動画/01_台本/${currentRenderSpec.title}.json`;
