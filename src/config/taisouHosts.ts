...
export const TAISOU_HOSTS: TaisouHost[] = [
  {
    ...
    hostName: "もぐぴよ",
    hostImage: "/content/fuwafuwa-land/characters/display/mogupiyo.png",
    kana: ["あ", "い", "う", "え", "お"],
  ...
  },
  {
    ...
    hostName: "シンボー",
    hostImage: "/content/fuwafuwa-land/characters/display/shinbo.png",
    kana: ["ゆ", "っ", "く", "り"],
  ...
  },
  {
    ...
    hostName: "酸化わーわー",
    hostImage: "/content/fuwafuwa-land/characters/display/sanka.png",
    kana: ["す", "う", "ふ", "ー"],
