...
| workspace | `suwapuyo-SNS-video` | 使用可 | やっ太郎を主役に、最新OSS・動画手法を比較しながら9:16、キャラ一貫性、権利、公開Gateを検査する |
| workspace | `waawaa-short` | legacy reference | 旧すわぷよキャラ動画レンダラーの参照専用。新規SNS制作には使わない |
