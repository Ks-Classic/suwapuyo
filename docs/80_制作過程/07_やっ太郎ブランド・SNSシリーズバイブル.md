# じく太郎とやっ太郎 キャラクターIP設計・ブランド・SNSシリーズバイブル

> 文書状態: キャラクターIP設計v0.9.1。`じく太郎`と`やっ太郎`の名称・関係性はreviewed。造形数値・人格核・口調の全体承認前
> 最終更新: 2026-07-19
> 正本境界: 造形は`05`、技術方式は`06`、本書はキャラクターIP、人格、物語生成、ブランド、編集、投稿運用を扱う
> 306項目へ実際に回答したやっ太郎のキャラ案は[`09_やっ太郎キャラクター設定案_v0.2.md`](./09_やっ太郎キャラクター設定案_v0.2.md)を参照する。項目体系は本書、値は`09`を正とする。
...
最低限、`じく太郎 / ツナマヨ / すわぷよ利用者 / YourTIME運営 / 出展者 / AIエージェント / 自分自身`について別々に作る。
...
| CB-174 | Relative contrast | じく太郎と並んだ時の役割差 | P0 |
...
23. CB-127 Friction source（じく太郎との関係）
...
| 項目 | 現時点の仮説 | 状態 |
|---|---|---|
| Creator intent | AI時代の「できる」と「やってよい」の曖昧さを、やっ太郎の無自覚な越境と、じく太郎の注意・修正を通して、笑えて再利用できる知識にする | reviewed |
| Emotional promise | 驚き、愛嬌、安心して失敗を見られる感覚 | hypothesis |
| Official name | やっ太郎。「やったろう！」「何でもやってやろう！」を行動原理にした名前。公式やすキャラの公開名は`じく太郎` | reviewed |
| Relationship metaphor | 何でも先にやるやっ太郎と、社会的な軸・秩序・作者への敬意を守るじく太郎。注意する側／される側でも人格的には対等な相棒 | reviewed |
...
| Default action | やっ太郎は「とりあえず何でもやる」。外部公開や第三者影響の前に、じく太郎と運用Gateが止める | reviewed |
...
| Surprising boundary | 初期は作者・権利・権威の境界に無自覚だが、じく太郎に影響を示されると、言い訳せず止めて直す | reviewed |
| Jikutaro friction | やっ太郎は「AIでできるなら何でもやる」、じく太郎は「できても、作者・権利・社会的秩序を侵すなら止める」 | reviewed |
...
10. じく太郎が秩序を守ることへ固執して機会を逃し、やっ太郎の行動が正しかった時、二人はどう伝え直すか。
...
公式やすキャラの物語上・公開上の正式名は`じく太郎`とする。原画、権利台帳、asset IDでは既存の`公式やす`または`YASU-CHAR-001`を維持し、公開名の変更と権利対象の同一性を混同しない。

じく太郎は、社会的な軸を持ち、秩序、作者へのリスペクト、正当な権利・権威・意思決定権を守る真面目なキャラである。やっ太郎は「とりあえず何でもやる」ため、AI時代の曖昧な問題を悪意なく無自覚に越える。じく太郎は単に勢いを止めるのでなく、「できること」と「やってよいこと」の違い、誰の権利や意思を尊重すべきか、どう直せば続けられるかを注意し、社会へ接続する。

二人は注意する側／される側であっても人格的には対等な相棒である。やっ太郎の行動が未知を開き、じく太郎の軸がそれを作者と社会を尊重した形へ整える。物語上の越境は未公開sandbox、架空素材、許諾済み素材で再現し、現実の侵害を学習材料として実行しない。

## 2. キャラの核

### 一文定義

> 「やったろう！」で何でも先にやり、AI時代の曖昧な境界まで無自覚に越えてしまう。じく太郎に作者と社会への影響を注意され、やったことを隠さず、敬意を持つ方法へ直して次の力にする、爬虫類の実験隊長・やっ太郎。
...
| 技術力 | 55 | 30〜85 | 試せるが、作者尊重・権利・社会実装はじく太郎に学ぶ |
| 愛嬌 | 95 | 85〜100 | 悪意はないが、無自覚な越境で他者へ影響し得る |
...
| 項目 | じく太郎 | やっ太郎 |
|---|---|---|
| 組織内役割 | 社会的な軸、秩序、作者尊重、権利・事実の解説 | 実験隊長、何でも試す、曖昧な境界の可視化 |
| 強み | 「できる」と「やってよい」を分け、誰を尊重すべきか示す | AIで可能性を最速で実物にする |
| 弱み | 秩序を守ることへ寄りすぎ、未知の行動が遅くなることがある | 許諾、出典、作者意思、社会的影響を無自覚に飛ばす |
| 口調 | 真面目で端的。行為、影響、作者、直し方を分ける | 短く速い。「とりあえずやる」が先に出る |
| 成功時 | 作者・協力者と再現条件を明示する | まず喜び、次も何かやろうとする |
| 問題発生時 | 人格で叱らず、侵した境界と理由を注意する | 無自覚だったことを認め、止めて直す |
| CTA | 根拠、ルール、作者、正しい利用へ案内 | まず試す、続きを見る、一緒に考える |

じく太郎が毎回正解を知る構図にはしない。既存秩序が新技術へ追いついていない問題も扱い、二人で作者、当事者、専門家へ確認する。やっ太郎を単なる違反者・無能役にせず、行動したから見えた新しい問題と成功を必ず作る。
...
日付、料金、権利、健康、データ、協力者、成果、失敗の事実は曖昧にしない。キャラの冗談と実在情報を同じ吹き出しで混ぜない。訂正はじく太郎または運営が現実層で明確に行う。
...
画像内に文字を入れる場合は、原則として文字も含めてGPT Image 2で一体生成する。あとから手組み・合成で整えない。指定文言、改行、句読点、可読性をOCRと人の目で確認し、崩れた場合は同モデルで再生成する。詳細は`05_やっ太郎キャラクター正本・生成統制.md` §13.2Aを正とする。
...
- じく太郎の公式原画は、ポーズ、服、シャツの`Ai`、顔、尾を許可なく変えない。
...
3. 二人の名前が`じく太郎`と`やっ太郎`になった。「軸を守る」と「何でもやる」の宣言。
4. いとこをAIで1枚描くのは簡単。同じ子を100回出すのは難しい。
5. 線が変わった。なぜ違和感が出たか。
6. じく太郎のシャツから`Ai`が消えた事件。AIが描けても作者の原画を勝手に変えてよいわけではない。
...
- やっ太郎単独の人気と、じく太郎・すわぷよへの送客が両立したか。
...
- [ ] じく太郎との差、二人の関係、物語内／メタ／現実の境界を確認。
- [ ] 初期12投稿から3本を制作し、並べた時の人格・世界観を確認。
- [ ] 32px、カルーセル、9:16、無音、字幕、色覚、読み上げを確認。
- [ ] rights 証拠、asset manifest、公開Gateを通過。
