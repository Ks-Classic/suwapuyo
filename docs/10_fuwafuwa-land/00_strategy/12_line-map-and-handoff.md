...
まず読む:
1. `docs/10_fuwafuwa-land/00_strategy/11_system-design-and-flow.md`
2. `docs/10_fuwafuwa-land/00_strategy/12_line-map-and-handoff.md`
3. `docs/10_fuwafuwa-land/00_strategy/09_line-village-guide.md`
4. `docs/10_fuwafuwa-land/07_sponsor-tap-popup-spec.md`
5. `src/App.tsx`
