...
2D、Live2D、3D、GPT Image 2等を横断するキャラクター同一性、Character Master、生成物の承認・version・regression・rollbackは`05_cousin-character-master-and-generative-governance.md`、用途別技術選定と2026-07比較は`06_character-consistency-technology-landscape-2026-07.md`を正とする。
