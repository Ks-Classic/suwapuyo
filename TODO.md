...
- **裏モード**: display画面でサンプルのわーわーをタップすると `suwa-good-morning.mp3` が鳴る。5回連続タップで「わーわーもーど!」演出が出て、表示中の全キャラが見た目だけわーわー化する。もう5回で元に戻る。Supabase上の登録作品画像は変更しない。
...
- [x] **FL-G06c**: わーわータップ音＋5回タップ裏モード（表示中の全キャラを見た目だけわーわー化/復帰）
