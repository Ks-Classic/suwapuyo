...
- **裏モード**: display画面でサンプルのわーわーをタップすると `suwa-good-morning.mp3` が鳴る。5回連続タップで「わーわーもーど!」がぐるぐる登場し、最後に約1秒どーんと表示される。同時に表示中の全キャラが見た目だけわーわー化して大きくなり、わーわーが約20匹上から回転しながら降ってくる。裏モード中は全キャラが約1.5倍速で動く。もう5回で元に戻る。Supabase上の登録作品画像は変更しない。
...
- [x] **FL-G06c**: わーわータップ音＋5回タップ裏モード（どーん演出、全キャラわーわー化、20匹落下、1.5倍速、復帰）
